...
class Response:
  ...
  thrift_spec = (
    None, # 0
    (1, TType.STRING, 'id', None, None, ), # 1
    (2, TType.I32, 'push', None, None, ), # 2
    (3, TType.I32, 'show', None, None, ), # 3
    (4, TType.I32, 'click', None, None, ), # 4
    (5, TType.DOUBLE, 'cost', None, None, ), # 5
    (6, TType.I32, 'bid', None, None, ), # 6
    (7, TType.I32, 'bidres', None, None, ), # 7
    (8, TType.DOUBLE, 'selfcost', None, None, ), # 8
  )
  ...
  def read(self, iprot):
    ...
    while True:
      ...
      if fid == 1:
        ...
        if ftype == TType.I32:
          self.bid = iprot.readI32();
        else:
          iprot.skip(ftype)
      elif fid == 7:
        if ftype == TType.I32:
          self.bidres = iprot.readI32();
        else:
          iprot.skip(ftype)
      elif fid == 8:
        if ftype == TType.DOUBLE:
          self.selfcost = iprot.readDouble();
        else:
          iprot.skip(ftype)
      else:
        iprot.skip(ftype)
  ...
  def write(self, oprot):
    ...
    if self.push is not None:
      oprot.writeFieldBegin('push', TType.I32, 2)
      oprot.writeI32(self.push)
      oprot.writeFieldEnd()
    if self.show is not None:
      oprot.writeFieldBegin('show', TType.I32, 3)
      oprot.writeI32(self.show)
      oprot.writeFieldEnd()
    if self.click is not None:
      oprot.writeFieldBegin('click', TType.I32, 4)
      oprot.writeI32(self.click)
      oprot.writeFieldEnd()
    ...
    if self.bid is not None:
      oprot.writeFieldBegin('bid', TType.I32, 6)
      oprot.writeI32(self.bid)
      oprot.writeFieldEnd()
    if self.bidres is not None:
      oprot.writeFieldBegin('bidres', TType.I32, 7)
      oprot.writeI32(self.bidres)
      oprot.writeFieldEnd()
    if self.selfcost is not None:
      oprot.writeFieldBegin('selfcost', TType.DOUBLE, 8)
      oprot.writeDouble(self.selfcost)
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
    oprot.writeStructEnd()
